...
public class DGHTreeOrg
{
    ...
    public DGHTreeOrg(DGHNode root){
        this.root = root;
    }

    public DGHTreeOrg(String file) throws FileNotFoundException{
        readIn(file);
    }
     ...
     */
    public DGHTreeOrg createDGHTree(ArrayList<String> values) throws FileNotFoundException{
        ...
        DGHTreeOrg tree = new DGHTreeOrg();
     ...
     * @throws java.io.FileNotFoundException
     */
    public DGHTreeOrg createDGHTreeForDate(ArrayList<String> dates) throws FileNotFoundException{
        DGHTreeOrg tree = new DGHTreeOrg();
     ...
     * @return DGH tree
     */
    public DGHTreeOrg createRangesDatesDGHTrees(ArrayList<String> dates){
        ...
        DGHTreeOrg tree = new DGHTreeOrg(new DGHNode("****"));
    ...
    */
    public static void main(String[] args) throws FileNotFoundException {
        ...
        DGHTreeOrg tree2 = new DGHTreeOrg();
        ...
        DGHTreeOrg tree3 = new DGHTreeOrg("/Users/valentinlanger/IdeaProjects/dataFly/src/datafly/" + "dghSex");
        DGHTreeOrg tree4 = new DGHTreeOrg("/Users/valentinlanger/IdeaProjects/dataFly/src/datafly/" + "dghRace");
