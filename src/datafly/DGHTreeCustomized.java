 ...
 * @author Dunni
 */
public class DGHTreeCustomized
{
    ...
    public DGHTreeCustomized(){
        
    }
    
    public DGHTreeCustomized(DGHNode root){
        this.root = root;
    }

    public DGHTreeCustomized(String file) throws FileNotFoundException{
        readIn(file);
    }
     ...
     */
    public DGHTreeCustomized createDGHTree(ArrayList<String> values) throws FileNotFoundException{
        ...
        //ArrayList<ArrayList> valueNodeParents = new ArrayList<>();
            ...
            String dghFile = "/Users/valentinlanger/IdeaProjects/dataFly/src/datafly/createdDGHTree.txt";
     ...
     * @throws java.io.FileNotFoundException
     */
    public DGHTreeCustomized createDGHTreeForDate(ArrayList<String> dates) throws FileNotFoundException{
        DGHTreeCustomized tree = new DGHTreeCustomized();
     ...
     * @return DGH tree
     */
    public DGHTreeCustomized createRangesDatesDGHTrees(ArrayList<String> dates){
        ...
        DGHTreeCustomized tree = new DGHTreeCustomized(new DGHNode("****"));
    ...
    public DGHTreeCustomized createAgeDGHTrees(ArrayList<String> dates) throws FileNotFoundException{
        ArrayList<Integer> years = new ArrayList<>();
        ArrayList<String> yearRanges = new ArrayList<>();
        for(int i = 0; i < dates.size();i++){
            String year = dates.get(i);
    ...
    */
    public static void main(String[] args) throws FileNotFoundException {
        ...
        DGHTreeCustomized tree2 = new DGHTreeCustomized();
        ...
        DGHTreeCustomized tree3 = new DGHTreeCustomized("/Users/valentinlanger/IdeaProjects/dataFly/src/datafly/dghSex");
        DGHTreeCustomized tree4 = new DGHTreeCustomized("/Users/valentinlanger/IdeaProjects/dataFly/src/datafly/dghRace");
